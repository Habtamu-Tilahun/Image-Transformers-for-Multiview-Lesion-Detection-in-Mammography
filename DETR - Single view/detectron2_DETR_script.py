...
os.environ['CUDA_VISIBLE_DEVICES']='MIG-b0b0b665-6a1f-5670-85c4-dd3b6a9a25c1'
...
sys.path.append('/home/habtamu/DETR_from_Detectron2/detr')
...
# Save config to file
config_file = 'config_final_46k_25e-05_512.yaml'
with open("/home/habtamu/DETR_from_Detectron2/outputs/"+config_file, "w") as f:
    f.write(cfg.dump())